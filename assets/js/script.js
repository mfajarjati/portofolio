...
bookara: {
  ...
  highlights: [
    ...
    "Mengembangkan dashboard modern untuk memantau aktivitas serta statistik data.",
    ...
    "Menyediakan fitur ekspor data dan laporan untuk mempermudah pengelolaan katalog.",
  ...
  challenges: [
    ...
    "Mengoptimalkan performa dashboard melalui pagination, filtering, dan pencarian real-time.",
    "Membangun komponen frontend yang reusable agar mudah dikembangkan di masa mendatang.",
    "Menjaga konsistensi tampilan menggunakan Mantine UI pada berbagai ukuran perangkat.",
    ...
    "Menyusun struktur project yang modular sehingga mudah dipelihara dan dikembangkan.",
  ],
  outcome: [
    ...
    "Menyediakan RESTful API yang aman menggunakan autentikasi JWT untuk mendukung integrasi aplikasi.",
    "Menghasilkan dashboard yang responsif, modern, dan mudah digunakan pada berbagai perangkat.",
    "Membangun aplikasi yang scalable dengan pemisahan frontend dan backend sehingga mudah dikembangkan.",
